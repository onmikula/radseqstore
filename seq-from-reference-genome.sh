...
#while read loc
#do
#mafft-profile "tobejoined/$loc""_ref.fasta" "tobejoined/$loc""_seq.fasta" > "tobejoined/$loc"".fasta"
##mafft-profile --thread 4 "tobejoined/$loc""_ref.fasta" "tobejoined/$loc""_seq.fasta" > "tobejoined/$loc"".fasta"
